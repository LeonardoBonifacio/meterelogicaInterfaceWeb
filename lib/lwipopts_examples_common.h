...
#define MEM_SIZE                    32000 // Define o tamanho total do heap interno do LwIP (se MEM_LIBC_MALLOC for 0).
#define MEMP_NUM_TCP_SEG            64   // Número máximo de segmentos TCP (partes de dados) que podem ser alocados de uma vez.
#define MEMP_NUM_ARP_QUEUE          16   // Número máximo de pacotes que podem ser enfileirados esperando por uma resposta ARP.
#define PBUF_POOL_SIZE              48   // Número de "pbufs" no pool de alocação de pacotes.
